...
Operational decisions should be reproducible.

### Explicit state

The system should expose why an operation was allowed, warned, blocked, or rejected.

### Minimal kernel

The deterministic kernel should remain small and understandable.

### Separation of concerns

Scanning, redaction, token accounting, UI behaviour, AI inference, and deterministic evaluation should remain distinct responsibilities.

### Local-first operation

The default architecture is designed around local project processing and local AI inference.

### Human control

RAG Studio assists with context preparation and operational evaluation. It does not autonomously modify or destroy customer project data.

### Audit the operation, not the customer's content

Operational evidence should describe what happened without unnecessarily reproducing the material being processed.

---

## Project Status

**v2.1.0 development branch**

RAG Studio AI Wrapper is currently undergoing hardening and validation of its v2.1 architecture.
...
Future development may expand the context pipeline, user interface, and deployment model.

---

## License

RAG Studio AI Wrapper is released under the **MIT License**.

Copyright © 2026 StoneVeld Studios.
